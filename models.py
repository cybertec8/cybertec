...
class User(db.Model, UserMixin):
    ...
    mobile_number = db.Column(db.String(15), default="") # Added as requested
    teams = db.Column(db.String(150), default="")
    events = db.Column(db.String(150), default="")
    bio = db.Column(db.Text, default="")
    profile_image = db.Column(db.String(255), nullable=True, default="uploads/profile/default.png")
    
    # AVATAR SYSTEM
    avatar_type = db.Column(db.String(20), default="default") # "default" or "custom"
